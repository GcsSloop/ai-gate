...
func (s *Store) migrate() error {
	...
	for _, column := range []struct {
		...
		{table: "account_usage_snapshots", name: "provider_snapshot_json", definition: "TEXT NOT NULL DEFAULT ''"},
		{table: "account_usage_snapshots", name: "stale", definition: "INTEGER NOT NULL DEFAULT 0"},
		{table: "account_usage_snapshots", name: "last_error", definition: "TEXT NOT NULL DEFAULT ''"},
		...
		{table: "accounts", name: "proxy_mode", definition: "TEXT NOT NULL DEFAULT ''"},
